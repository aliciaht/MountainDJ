Shader "Ciconia Studio/Effects/Wind/Forward/Advanced/2Sided/Transparent" {
    Properties {
...
/// Final Color:
                ...
                float Transparent = saturate(((lerp( lerp( (1.0 - node_3968), node_3968, _InvertAlbedoAlpha ), 1.0, _DisableAlbedoAlphaChannel )-_AlphaAmount)*(lerp( (1.0 - _AdditionalTransparentmap_var.r), _AdditionalTransparentmap_var.r, _InvertAdditionalmap )+1.0)));
