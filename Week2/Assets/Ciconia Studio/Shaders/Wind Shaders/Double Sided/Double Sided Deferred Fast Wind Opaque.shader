Shader "Ciconia Studio/Effects/Wind/Deferred/Fast/2Sided/Opaque" {
    Properties {
...
////// Specular:
                float node_3780 = 0.0;
                float3 specularColor = float3(node_3780,node_3780,node_3780);
...
/// Final Color:
                ...
                outEmission = half4( Emissivemap, 1 );
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float node_3780 = 0.0;
                float3 specColor = float3(node_3780,node_3780,node_3780);
