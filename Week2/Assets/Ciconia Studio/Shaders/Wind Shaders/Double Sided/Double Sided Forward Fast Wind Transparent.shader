Shader "Ciconia Studio/Effects/Wind/Forward/Fast/2Sided/Transparent" {
    Properties {
        [Space(15)][Header(Main Properties)]
        [Space(20)]_Color ("Color", Color) = (1,1,1,1)
        _MainTex ("Albedo (Transparent A)", 2D) = "white" {}
        ...
        [Space(15)][MaterialToggle] _InvertAdditionalmap ("Invert Additional map", Float ) = 1
        _AdditionalTransparentmap ("Additional Transparent map", 2D) = "black" {}
        [Space(15)]_AlphaAmount ("Alpha Amount", Range(-0.5, 1)) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _AdditionalTransparentmap; uniform float4 _AdditionalTransparentmap_ST;
...
/// Final Color:
                ...
                float node_6067 = AlbedoA;
                float4 _AdditionalTransparentmap_var = tex2D(_AdditionalTransparentmap,TRANSFORM_TEX(i.uv0, _AdditionalTransparentmap));
                float Transparent = saturate(((lerp( lerp( (1.0 - node_6067), node_6067, _InvertAlbedoAlpha ), 1.0, _DisableAlbedoAlphaChannel )-_AlphaAmount)*(lerp( (1.0 - _AdditionalTransparentmap_var.r), _AdditionalTransparentmap_var.r, _InvertAdditionalmap )+1.0)));
