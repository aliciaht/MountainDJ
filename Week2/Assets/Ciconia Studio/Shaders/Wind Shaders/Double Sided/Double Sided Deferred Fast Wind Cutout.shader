Shader "Ciconia Studio/Effects/Wind/Deferred/Fast/2Sided/Cutout" {
    Properties {
...
////// Specular:
                float node_3323 = 0.0;
                float3 specularColor = float3(node_3323,node_3323,node_3323);
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float node_3323 = 0.0;
                float3 specColor = float3(node_3323,node_3323,node_3323);
